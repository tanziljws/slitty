...
<div class="w-full max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Tambah Agenda</h1>
            <p class="text-gray-600 mt-1">Buat agenda kegiatan baru</p>
        </div>
        ...
        <form action="{{ route('agenda.store') }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" name="date_label" value="{{ old('date_label') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Senin, Periode Akhir Semester" required>
                ...
                <div>
                    ...
                    <input type="text" name="time" value="{{ old('time') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="08:00 - 10:00 WIB" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="date" name="event_date" value="{{ old('event_date') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
